...
class Screen:
    ...
    def draw_screen(self):
        ...
        if not self.instartmenu:
            ...
            high = scorefont.render(
                f"HIGH SCORE: {scorecounter.highscore}", True, self.blue)
    ...
    def wingame(self):
        ...
        scoretext = font.render(
            f"Score: {scorecounter.score}", True, self.black)
        highscoretext = font.render(
            f"High score: {scorecounter.highscore}", True, self.black)
        instructions = font.render(
            "Press R to restart the game", True, self.black)
        self.screen.fill(self.white)
    ...
    def losegame(self):
        ...
        highscoretxt = font.render(
            f"High score: {scorecounter.highscore}", True, self.red)
        instructions = font.render(
            f"Press R to restart the game", True, self.red)
